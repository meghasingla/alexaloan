...
$mailer->from('alexafincorp@gmail.com')
	...
	->html(parseTemplate('contact-mailtransfer.html', $_REQUEST))->send('inquiries@alexafincorp.com');

$mailer->from('alexafincorp@gmail.com')
	->replyTo('inquiries@alexafincorp.com')
	->subject('Enquiry Mail')
	->html(parseTemplate('contact-transferloan.html', $_REQUEST))->send($_REQUEST['email']);
