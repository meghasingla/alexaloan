...
$mailer->from('alexafincorp@gmail.com')
	...
	->html(parseTemplate('contact-mailagainst.html', $_REQUEST))->send('inquiries@alexafincorp.com');

$mailer->from('alexafincorp@gmail.com')
	->replyTo('inquiries@alexafincorp.com')
	->subject('ENQUIRY MAIL(Do not Reply on this mail)')
	->html(parseTemplate('contact-LoanAgainst.html', $_REQUEST))->send($_REQUEST['email']);
} 
catch (\Exception $e) {
